 ...
 */
public class mv_PlaceNameService
{
...
//    private static final String FORMAT_SUFFIX = ".xml.gz";
    private static final String FORMAT_SUFFIX = ".xml";//AliSoft
...
//    private boolean addVersionTag = true;//AliSoft
     ...
     */
    public mv_PlaceNameService(String service, String dataset, String fileCachePath, Sector sector, LatLon tileDelta,
...
//        sb.append("&OUTPUTFORMAT=SHAPE-ZIP");//AliSoft
        sb.append("&OUTPUTFORMAT=GML2");//AliSoft
//        sb.append("&maxFeatures=50");//AliSoft
        sb.append("&BBOX=");
    ...
    public synchronized final mv_PlaceNameService deepCopy()
    {
        mv_PlaceNameService copy = new mv_PlaceNameService(this.service, this.dataset, this.fileCachePath, maskingSector,
    ...
    public boolean equals(Object o)
    {
        ...
        final mv_PlaceNameService other = (mv_PlaceNameService) o;
