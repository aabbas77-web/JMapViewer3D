 ...
 */
public class mv_WFSPlaceNameLayer extends mv_PlaceNameLayer {
    ...
    private static mv_PlaceNameServiceSet makePlaceNameServiceSet() {
...
//        final String fileCachePath = "Earth/PlaceNames/WFSPlaceNamesVersion1.0";
        final String service = "http://localhost:8080/geoserver/MapViewer/ows";
        final String fileCachePath = "MapViewer/PlaceNames/WFSPlaceNamesVersion1.0";
        mv_PlaceNameServiceSet placeNameServiceSet = new mv_PlaceNameServiceSet();
        placeNameServiceSet.setExpiryTime(new GregorianCalendar(2008, 1, 11).getTimeInMillis());
        mv_PlaceNameService placeNameService;
        final boolean addVersionTag=true;  //true if pointing to a new wfs server
        
        // Places
//        if (activeNamesList.contains(OCEANS))
        {
//            placeNameService = new mv_PlaceNameService(service, "MapViewer:gis_osm_places_free_1", fileCachePath, Sector.FULL_SPHERE, GRID_36x72,
            placeNameService = new mv_PlaceNameService(service, "MapViewer:gis_osm_places_free_1", fileCachePath, Sector.fromDegrees(32.323405, 37.2874423, 35.7218908, 42.3707913), GRID_36x72,
                    java.awt.Font.decode("Tahoma-BOLDITALIC-12"), addVersionTag);
//            placeNameService.setColor(new java.awt.Color(200, 200, 200));
            placeNameService.setColor(new java.awt.Color(255, 255, 128));
...
//        {
////            placeNameService = new mv_PlaceNameService(service, "MapViewer:gis_osm_places_free_1", fileCachePath, Sector.FULL_SPHERE, GRID_36x72,
//            placeNameService = new mv_PlaceNameService(service, "MapViewer:gis_osm_roads_free_1", fileCachePath, Sector.fromDegrees(32.323405, 37.2874423, 35.7218908, 42.3707913), GRID_36x72,
//                    java.awt.Font.decode("Tahoma-BOLDITALIC-12"), addVersionTag);
////            placeNameService.setColor(new java.awt.Color(200, 200, 200));
//            placeNameService.setColor(new java.awt.Color(255, 255, 128));
//            placeNameService.setMinDisplayDistance(0d);
