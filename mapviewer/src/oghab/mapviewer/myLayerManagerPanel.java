 ...
 */
public class myLayerManagerPanel extends JPanel
{
    protected JPanel layerNamesPanel;
    protected List<myLayerPanel> layerPanels = new ArrayList<myLayerPanel>();
    protected Font plainFont;
    protected Font boldFont;

    public myLayerManagerPanel(final WorldWindow wwd)
    {
    ...
    protected void fill(WorldWindow wwd)
    {
        ...
        for (Layer layer : wwd.getModel().getLayers())
        {
            ...
            myLayerPanel layerPanel = new myLayerPanel(wwd, layer);
    ...
    {
        for (myLayerPanel layerPanel : this.layerPanels)
        {
