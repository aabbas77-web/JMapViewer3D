...
public class KMLOrbitViewController extends KMLViewController
{
    ...
    protected void goTo(KMLLookAt lookAt)
    {
        ...
        String strAltitudeMode = lookAt.getAltitudeMode();
        ...
        //AliSoft
        int altitudeMode = KMLUtil.convertAltitudeMode(strAltitudeMode, WorldWind.CLAMP_TO_GROUND);
        ...
        FlyToOrbitViewAnimator animator = FlyToOrbitViewAnimator.createFlyToOrbitViewAnimator(this.orbitView,
            ...
            this.orbitView.getZoom(), range, timeToMove, altitudeMode); // KML default
    ...
    protected void goTo(KMLCamera camera)
    {
        ...
        String strAltitudeMode = camera.getAltitudeMode();
        ...
        //AliSoft
        int altitudeMode = KMLUtil.convertAltitudeMode(strAltitudeMode, WorldWind.RELATIVE_TO_GROUND);
        ...
        FlyToOrbitViewAnimator panAnimator = createFlyToOrbitViewAnimator(this.orbitView, cameraPosition,
            ...
            altitudeMode); // Camera default, differs from KML default
