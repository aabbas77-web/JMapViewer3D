 ...
 */
public class myElevationModelPanel extends JPanel
{
    ...
    public myElevationModelPanel(final WorldWindow wwd, final myElevationModelManagerPanel emPanel,
                               final ElevationModel elevationModel)
    {
        ...
        this.upButton = new JButton(myLayerPanel.UP_ARROW);
        ...
        this.downButton = new JButton(myLayerPanel.DOWN_ARROW);
