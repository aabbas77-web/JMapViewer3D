 ...
 */
public class myLineBuilder extends AVListImpl {
     ...
     */
    public myLineBuilder(final WorldWindow wwd, RenderableLayer lineLayer, Path path, PropertiesFrame propertiesFrame, ActionListener action) {
        this.wwd = wwd;
        ...
        normalShapeAttributes.setOutlineMaterial(Material.YELLOW);
        normalShapeAttributes.setOutlineWidth(3.0);

        highlightShapeAttributes = new BasicShapeAttributes();
        highlightShapeAttributes.setInteriorMaterial(Material.RED);
        highlightShapeAttributes.setOutlineMaterial(Material.YELLOW);
        
        line.setExtrude(false);

        line.setAttributes(normalShapeAttributes);
        line.setHighlightAttributes(highlightShapeAttributes);

        line.setValue(AVKey.SHORT_DESCRIPTION, "Short description of Path");
        line.setValue(AVKey.BALLOON_TEXT, "This is a Path.");
...
//            }
    ...
    private static class LinePanel extends JPanel {
        ...
        private final WorldWindow wwd;
        private final myLineBuilder lineBuilder;
        private JButton newButton;
        private JButton pauseButton;
        private JButton endButton;
        private JLabel[] pointLabels;

        public LinePanel(WorldWindow wwd, myLineBuilder lineBuilder) {
     ...
     */
    @Deprecated
    public static class AppFrame extends myApplicationTemplate.AppFrame {

        public AppFrame() {
            super(true, false, false);

            myLineBuilder lineBuilder = new myLineBuilder(this.getWwd(), null, null, null, null);
    ...
    public static void main(String[] args) {
        ...
        myApplicationTemplate.start("WorldWind Line Builder", myLineBuilder.AppFrame.class);
    }
}
