...
public class myMGRSAttributesPanel extends JPanel
{
    // Logical components.
    ...
    public myMGRSAttributesPanel(MGRSGraticuleLayer mgrsGraticuleLayer)
    {
    ...
    public static JDialog showDialog(Component component, String title, MGRSGraticuleLayer mgrsGraticuleLayer)
    {
        ...
        myMGRSAttributesPanel panel = new myMGRSAttributesPanel(mgrsGraticuleLayer);
        ...
        if (event != null && graticuleType != null)
        {
            if (!this.ignoreUIEvents)
            {
                if (//event.getPropertyName().equals(GraticuleAttributesPanel.LINE_ENABLED_PROPERTY)
                    event.getPropertyName().equals(myGraticuleAttributesPanel.LINE_COLOR_PROPERTY)
                    || event.getPropertyName().equals(myGraticuleAttributesPanel.LINE_WIDTH_PROPERTY)
                    || event.getPropertyName().equals(myGraticuleAttributesPanel.LINE_STYLE_PROPERTY)
                    || event.getPropertyName().equals(myGraticuleAttributesPanel.LABEL_ENABLED_PROPERTY)
                    || event.getPropertyName().equals(myGraticuleAttributesPanel.LABEL_COLOR_PROPERTY)
                    || event.getPropertyName().equals(myGraticuleAttributesPanel.LABEL_FONT_PROPERTY))
                {
                    updateLayer();
                }
            }
        ...
        try
        {
            if (this.layer != null)
            {
                ...
                for (Map.Entry<String, Component> entry : this.graticuleAttribPanelMap.entrySet())
                {
                    ...
                    {
                        if (entry.getValue() instanceof myGraticuleAttributesPanel)
                        {
                            updateLayerState((myGraticuleAttributesPanel) entry.getValue(), entry.getKey());
                        }
                    }
                }
            }
    ...
    private void updateLayerState(myGraticuleAttributesPanel attributesPanel, String graticuleType)
    {
        ...
        try
        {
            ...
            for (Map.Entry<String, Component> entry : this.graticuleAttribPanelMap.entrySet())
            {
                if (entry.getKey() != null && entry.getValue() != null)
                {
                    if (entry.getValue() instanceof myGraticuleAttributesPanel)
                    {
                        updatePanelState((myGraticuleAttributesPanel) entry.getValue(), entry.getKey());
                    }
                }
            }
        }
    ...
    private void updatePanelState(myGraticuleAttributesPanel panel, String graticuleType)
    {
    ...
    private Component makeGraticulePanel(final String graticuleType)
    {
        ...
        myGraticuleAttributesPanel panel = new myGraticuleAttributesPanel();
