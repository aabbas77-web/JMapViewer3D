...
import oghab.mapviewer.KMLViewController;
 ...
 */
public class myBalloonController extends MouseAdapter implements SelectListener
{
     ...
     */
    public myBalloonController(WorldWindow wwd)
    {
        if (wwd == null)
        {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                if (root != null)
                {
                    ...
                    SwingUtilities.invokeLater(new Runnable()
                    {
                        public void run()
                        {
                            myBalloonController.this.onDocumentLoaded(docUrl, pinnedRoot, featureRef);
                        }
                    });
            ...
            catch (final Exception e)
            {
                ...
                SwingUtilities.invokeLater(new Runnable()
                {
                    public void run()
                    {
                        myBalloonController.this.onDocumentFailed(docUrl, e);
                    }
                });
                this.cancel();
            }
