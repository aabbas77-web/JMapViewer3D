 ...
 * @see BulkRetrievable
 */
public class myBulkDownloadPanel extends JPanel
{
    ...
    public myBulkDownloadPanel(WorldWindow wwd)
    {
        this.wwd = wwd;
        ...
        protected void doUpdateDescription(final Sector sector)
        {
            if (sector != null)
            {
                try
                {
                    ...
                    final String formattedSize = myBulkDownloadPanel.makeSizeDescription(size);
    ...
    public class DownloadMonitorPanel extends JPanel
    {
        ...
        protected void updateStatus()
        {
            ...
            text += " (" + myBulkDownloadPanel.makeSizeDescription(this.progress.getCurrentSize())
                + " / " + myBulkDownloadPanel.makeSizeDescription(this.progress.getTotalSize())
                + ")";
            ...
            // Update tooltip
            String tooltip = myBulkDownloadPanel.makeSectorDescription(this.thread.getSector());
