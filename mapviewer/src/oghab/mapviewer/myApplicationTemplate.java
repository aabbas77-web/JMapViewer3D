...
import javax.swing.*;
import java.awt.*;
import static oghab.mapviewer.MeasureFrame.frame;
 ...
 */
public class myApplicationTemplate {
    ...
    public static class AppPanel extends JPanel {
        ...
        public AppPanel(Dimension canvasSize, boolean includeStatusBar) {
            ...
            this.wwd.addSelectListener(new myClickAndGoSelectListener(this.getWwd(), WorldMapLayer.class));
    ...
    protected static class AppFrame extends JFrame {
        ...
        protected myLayerPanel2 layerPanel;
        ...
        protected void initialize(boolean includeStatusBar, boolean includeLayerPanel, boolean includeStatsPanel) {
            ...
            if (includeLayerPanel) {
                ...
                this.layerPanel = new myLayerPanel2(this.getWwd());
                this.controlPanel.add(this.layerPanel, BorderLayout.CENTER);
                this.controlPanel.add(new myFlatWorldPanel(this.getWwd()), BorderLayout.NORTH);
         ...
         */
        @Deprecated
        public myLayerPanel2 getLayerPanel() {
...
//AliSoft            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

            // AliSoft
            ImageIcon icon = new ImageIcon(appFrameClass.getResource("/res/mapviewer_icon.png"));  
    ...
    public static void main(String[] args) {
        ...
        myApplicationTemplate.start("WorldWind Application", AppFrame.class);
    }
}
