...
public class IconsFrame extends javax.swing.JFrame {
    ...
    static public IconsFrame frame = null;
    ...
    {
        try {
            listPngFiles(MainFrame.strIconsPath);
        } catch (IOException ex) {
            Logger.getLogger(IconsFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        P_IconLayout.setVerticalGroup(
            ...
            .addGroup(P_IconLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(P_IconLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(L_IconPath, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
