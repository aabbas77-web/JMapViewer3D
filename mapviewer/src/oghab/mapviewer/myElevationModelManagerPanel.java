 ...
 */
public class myElevationModelManagerPanel extends JPanel
{
    protected JPanel modelNamesPanel;
    protected List<myElevationModelPanel> modelPanels = new ArrayList<myElevationModelPanel>();


    public myElevationModelManagerPanel(final WorldWindow wwd)
    {
    ...
    protected void fill(WorldWindow wwd)
    {
        ...
        {
            myElevationModelPanel elevationModelPanel = new myElevationModelPanel(wwd, this,
        ...
        else
        {
            ...
            for (ElevationModel elevationModel : cem.getElevationModels())
            {
                ...
                myElevationModelPanel elevationModelPanel = new myElevationModelPanel(wwd, this, elevationModel);
                this.modelPanels.add(elevationModelPanel);
                this.modelNamesPanel.add(elevationModelPanel);
            }
        }
