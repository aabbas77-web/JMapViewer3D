...
public class LayersViewer
{
    protected JPanel panel;
    static public myLayerManagerPanel layerPanel;
    
    public LayersViewer(WorldWindowGLCanvas wwd)
    {
        this.panel = new JPanel(new BorderLayout(5, 5));

        layerPanel = new myLayerManagerPanel(wwd);
    ...
    public static void update(WorldWindowGLCanvas wwd)
    {
        layerPanel.update(wwd);
    }
...
//                frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);// AliSoft
                ...
                LayersViewer viewerPanel = new LayersViewer(wwd);
