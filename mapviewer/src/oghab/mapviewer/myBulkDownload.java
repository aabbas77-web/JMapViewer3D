 ...
 */
public class myBulkDownload extends myApplicationTemplate
{
    public static class AppFrame extends myApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            this.getControlPanel().add(new myBulkDownloadPanel(this.getWwd()), BorderLayout.SOUTH);
    ...
    {
        myApplicationTemplate.start("Download", AppFrame.class);
    }
}
