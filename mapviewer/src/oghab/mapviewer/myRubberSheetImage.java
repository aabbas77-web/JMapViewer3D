 ...
 */
public class myRubberSheetImage extends JFrame implements ActionListener
{
    ...
    public myRubberSheetImage(WorldWindowGLCanvas wwd)
    {
        this.wwd = wwd;
    ...
    private void initComponents()
    {
        ...
        controlBox.setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20)); // top, left, bottom, right
        {
            ...
            slider.addChangeListener(new ChangeListener()
            {
                public void stateChanged(ChangeEvent event)
                {
                    ...
                    myRubberSheetImage.this.actionPerformed(actionEvent);
                }
            });
        ...
        this.add(controlBox, BorderLayout.NORTH);
    }
...
//            insertBeforePlacenames(wwd, this.layer);
    ...
    {
        private myRubberSheetImage appFrame;
        ...
        public Controller(myRubberSheetImage appFrame)
        {
    ...
    static myRubberSheetImage frame;
...
//                JFrame frame = new JFrame();
                frame = new myRubberSheetImage(wwd);
