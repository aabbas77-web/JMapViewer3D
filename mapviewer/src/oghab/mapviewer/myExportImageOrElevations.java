 ...
 */
public class myExportImageOrElevations extends JFrame
{
    ...
    public myExportImageOrElevations(WorldWindowGLCanvas wwd)
    {
        this.wwd = wwd;
        ...
        JPanel btnPanel = new JPanel(new GridLayout(3, 1, 0, 0));
        {
            JButton
    ...
    {
        LayerList list = this.wwd.getModel().getLayers();
            ...
            public void run()
            {
                try
                {
                    ...
                    if (null != image)
                    {
                        ...
                        jd.setVisible(false);
                        JOptionPane.showMessageDialog(null, "Image saved into the " + saveToFile.getName());
                    }
                    else
                    {
                        jd.setVisible(false);
    ...
    static myExportImageOrElevations frame;
...
//                JFrame frame = new JFrame();
                frame = new myExportImageOrElevations(wwd);
