 ...
 */
public class myCrosshairLayer extends AbstractLayer
{
//    private String iconFilePath = "images/32x32-crosshair-simple.png"; // TODO: make configurable
    private String iconFilePath = "res/crosshair05_72.png"; // TODO: make configurable
    ...
    private class OrderedIcon implements OrderedRenderable
    {
        ...
        {
            myCrosshairLayer.this.draw(dc);
        }
    }

    public myCrosshairLayer()
    {
        this.setOpacity(0.8); // TODO: make configurable
    }

    public myCrosshairLayer(String iconFilePath)
    {
...
//            System.out.println("myCrosshairLayer iconStream: "+iconFilePath);
            if (iconStream == null)
            {
