 ...
 */
public class myPositionAnimator extends BasicAnimator
{
...
//        return Position.interpolateGreatCircle(interpolant, this.begin, this.end);
        Position pos = Position.interpolateGreatCircle(interpolant, this.begin, this.end);
        return Position.fromDegrees(pos.latitude.degrees,pos.longitude.degrees,pos.elevation + 5000);
    }
}
