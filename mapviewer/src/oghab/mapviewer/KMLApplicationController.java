...
import oghab.mapviewer.myBalloonController;
...
public class KMLApplicationController implements SelectListener, PropertyChangeListener
{
     ...
     */
    public myBalloonController getBalloonController()
    {
     ...
     */
    public void setBalloonController(myBalloonController balloonController)
    {
    ...
    {
        myBalloonController balloonController = this.getBalloonController();
