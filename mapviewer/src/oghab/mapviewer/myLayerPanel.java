...
import static oghab.mapviewer.MainFrame.goTo;
...
public class myLayerPanel extends JPanel
{
    public static final ImageIcon UP_ARROW =
        new ImageIcon(myLayerPanel.class.getResource("/res/up_arrow.png"));
    public static final ImageIcon DOWN_ARROW =
        new ImageIcon(myLayerPanel.class.getResource("/res/down_arrow.png"));
    public static final ImageIcon RIGHT_ARROW =
        new ImageIcon(myLayerPanel.class.getResource("/res/right_arrow.png"));
    ...
    public myLayerPanel(final WorldWindow wwd, final Layer layer)
    {
        ...
        this.rightButton = new JButton(RIGHT_ARROW);
        this.rightButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent actionEvent)
            {
                Sector sector = (Sector) layer.getValue("oghab.mapviewer.avKey.Sector");
                if(sector == null)  sector = (Sector) layer.getValue(AVKey.SECTOR);
                if(sector != null)  goTo(wwd, sector);
            }
        });
        ...
        this.rightButton.setPreferredSize(new Dimension(24, 24));
        ...
        Sector sector = (Sector) layer.getValue("oghab.mapviewer.avKey.Sector");
        if(sector == null)  sector = (Sector) layer.getValue(AVKey.SECTOR);
        this.rightButton.setEnabled(sector != null);
    }
