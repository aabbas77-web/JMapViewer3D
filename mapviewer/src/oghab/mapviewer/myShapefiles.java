 ...
 */
public class myShapefiles extends myApplicationTemplate
{
    ...
    public static class WorkerThread extends Thread
    {
        ...
        public void run()
        {
            try
            {
                final Layer layer = this.makeShapefileLayer(this.source, null);
        ...
        protected Layer makeShapefileLayer(Object source, String except)
        {
            if (myOpenStreetMapShapefileLoader.isOSMPlacesSource(source))
            {
                return myOpenStreetMapShapefileLoader.makeLayerFromOSMPlacesSource(source, except);
            }
            else
            {
                myShapefileLoader loader = new myShapefileLoader();
