 ...
 */
public class myMeasureToolPanel extends JPanel {
...
//    private JCheckBox freeHandCheck;
    ...
    public myMeasureToolPanel(WorldWindow wwdObject, MeasureTool measureToolObject, ResourceBundle bundle) {
        ...
        measureTool.addPropertyChangeListener((PropertyChangeEvent event) -> {
            ...
            if (event.getPropertyName().equals(MeasureTool.EVENT_POSITION_ADD)
                ...
                if (measureTool.isArmed()) {
                    ...
                    pauseButton.setText(bundle.getString("B_Pause"));
    ...
    private void makePanel(Dimension size) {
        ...
        shapePanel.add(new JLabel(bundle.getString("P_Shape")));
        shapeCombo = new JComboBox<>(new String[]{bundle.getString("CB_Line"), bundle.getString("CB_Path"), bundle.getString("CB_Polygon"), bundle.getString("CB_Circle"), bundle.getString("CB_Ellipse"), bundle.getString("CB_Square"), bundle.getString("CB_Rectangle")});
...
//        pathTypePanel.add(new JLabel(bundle.getString("P_Path_Type")));
//        pathTypeCombo = new JComboBox<>(new String[]{bundle.getString("CB_Linear"), bundle.getString("CB_Rhumb"), bundle.getString("CB_Great_Circle")});
...
//        unitsPanel.add(new JLabel(bundle.getString("L_Units")));
...
//        anglesPanel.add(new JLabel(bundle.getString("L_Angle_Format")));
...
//        anglesPanel.add(anglesCombo);
        ...
        followCheck = new JCheckBox(bundle.getString("CB_Follow_Terrain"));
        ...
        showControlsCheck = new JCheckBox(bundle.getString("CB_Control_Points"));
...
//        rubberBandCheck = new JCheckBox(bundle.getString("CB_Rubber_Band"));
...
//        checkPanel.add(rubberBandCheck);
        measureTool.getController().setUseRubberBand(true);

//        freeHandCheck = new JCheckBox(bundle.getString("CB_Free_Hand"));
...
//        checkPanel.add(freeHandCheck);
        ...
        showAnnotationCheck = new JCheckBox(bundle.getString("CB_Tooltip"));
...
//        lineColorButton = new JButton(bundle.getString("B_Line"));
//        lineColorButton.addActionListener((ActionEvent event) -> {
//            Color c = JColorChooser.showDialog(colorPanel,
//                    bundle.getString("CC_Choose_A_Color"), ((JButton) event.getSource()).getBackground());
//            if (c != null) {
...
//
//        pointColorButton = new JButton(bundle.getString("B_Points"));
...
//
//        annotationColorButton = new JButton(bundle.getString("CB_Tooltip"));
...
//        colorPanel.add(annotationColorButton);
        ...
        newButton = new JButton(bundle.getString("B_New"));
        ...
        pauseButton = new JButton(bundle.getString("B_Pause"));
        pauseButton.addActionListener((ActionEvent actionEvent) -> {
            measureTool.setArmed(!measureTool.isArmed());
            pauseButton.setText(!measureTool.isArmed() ? bundle.getString("B_Resume") : bundle.getString("B_Pause"));
            pauseButton.setEnabled(true);
        ...
        endButton = new JButton(bundle.getString("B_End"));
        ...
        presetPanel.add(bt);
        bt = new JButton(bundle.getString("B_Polygon"));
        bt.addActionListener((ActionEvent actionEvent) -> {
        ...
        metricPanel.setBorder(new CompoundBorder(
                new TitledBorder(bundle.getString("P_Metric")), BorderFactory.createEmptyBorder(5, 5, 5, 5)));
        metricPanel.add(new JLabel(bundle.getString("L_Length")));
        lengthLabel = new JLabel();
        metricPanel.add(lengthLabel);
        metricPanel.add(new JLabel(bundle.getString("L_Area")));
        areaLabel = new JLabel();
        metricPanel.add(areaLabel);
        metricPanel.add(new JLabel(bundle.getString("L_Width")));
        widthLabel = new JLabel();
        metricPanel.add(widthLabel);
        metricPanel.add(new JLabel(bundle.getString("L_Height")));
        heightLabel = new JLabel();
        metricPanel.add(heightLabel);
        metricPanel.add(new JLabel(bundle.getString("L_Heading")));
        headingLabel = new JLabel();
        metricPanel.add(headingLabel);
        metricPanel.add(new JLabel(bundle.getString("L_Center")));
        ...
        outerPanel.setBorder(
                new CompoundBorder(BorderFactory.createEmptyBorder(9, 9, 9, 9), new TitledBorder(bundle.getString("P_Measure"))));
        outerPanel.setToolTipText(bundle.getString("TT_Measure_Tool_Control_And_Info"));
    ...
    private void fillPointsPanel() {
        ...
        if (measureTool.getPositions() != null) {
            for (LatLon pos : measureTool.getPositions()) {
                ...
                String las = bundle.getString("L_Lat")+String.format(" %7.4f\u00B0", pos.getLatitude().getDegrees());
                String los = bundle.getString("L_Lon")+String.format(" %7.4f\u00B0", pos.getLongitude().getDegrees());
