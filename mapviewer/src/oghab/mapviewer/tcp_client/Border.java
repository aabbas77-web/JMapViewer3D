...
public class Border extends Canvas implements CommonSettings
{
    ...
    {
        parent.curTab = i;
        String s = (String)parent.cardNames.get(i);       
    ...
    public boolean mouseDown(Event event, int i, int j)
    {
        ...
        {
            Rectangle rectangle = (Rectangle)parent.tabPos.get(k);
    ...
    public void DrawTabs(Graphics g)
    {
        ...
        {
            String s = (String)parent.tabNames.get(j1);
            ...
            parent.tabPos.add(rectangle1);
            DrawTab(g, rectangle1.x, rectangle1.y, rectangle1.width, rectangle1.height, false, s);
            i1 += rectangle1.width;
        }

        Rectangle rectangle = (Rectangle)parent.tabPos.get(parent.curTab);
        DrawTab(g, rectangle.x, rectangle.y - 4, rectangle.width + 2, rectangle.height + 5, true, (String)parent.tabNames.get(parent.curTab));
    }
