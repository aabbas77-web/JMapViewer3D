...
//            System.out.println("AliSoft:addElevationModelToWorldWindow: "+em+" , "+params.toString());
        }
        catch (Exception e)
        {
            String message = Logging.getMessage("generic.CreationFromConfigurationFailed",
...
//                System.out.println("AliSoft:addElevationModelToWorldWindow: "+em+" , "+defaultElevationModel.getName());
            }
        }
        else
        {
